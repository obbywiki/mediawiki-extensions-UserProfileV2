# Fork of gitlab.com/telepedia/extensions/userprofilev2.git
View the original extension [here](https://gitlab.com/telepedia/extensions/userprofilev2).

Changes:
* Platform changes (including ui (profiles/edit), svgs, strings (en), etc.):
  * Added platforms:
   * Twitter
   * GitHub
   * Roblox
