...
class UserPage extends Article {
	...
	private function getProfileLayout() {
		...
		$globalEditCount = UserInformation::getGlobalEditCount($this->mUserProfile);

		if (UserInformation::shouldShowGlobalEditCount($this->mUserProfile) && !is_null($globalEditCount)) {
			$html .= Html::rawElement(
				"li",
				[],
