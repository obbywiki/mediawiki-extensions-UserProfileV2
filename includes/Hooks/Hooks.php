	...
	GetPreferencesHook
{
	...
	public function onGetPreferences( $user, &$preferences ): void {
		...
		$preferences['profile-bsky'] = [
			'type' => 'text',
			'label-message' => 'userprofilev2-bsky',
			'section' => 'personal/profile',
			'placeholder' => wfMessage( 'userprofilev2-bsky-placeholder' )->plain(),
			'help-message' => 'userprofilev2-bsky-help',
		];

		$preferences['profile-github'] = [
			'type' => 'text',
			'label-message' => 'userprofilev2-github',
			'section' => 'personal/profile',
			'placeholder' => wfMessage( 'userprofilev2-github-placeholder' )->plain(),
			'help-message' => 'userprofilev2-github-help',
		];

		$preferences['profile-roblox'] = [
			'type' => 'text',
			'label-message' => 'userprofilev2-roblox',
			'section' => 'personal/profile',
			'placeholder' => wfMessage( 'userprofilev2-roblox-placeholder' )->plain(),
			'help-message' => 'userprofilev2-roblox-help',
		];

		$preferences['profile-url'] = [
			'type' => 'text',
			'label-message' => 'userprofilev2-url',
			'section' => 'personal/profile',
			'placeholder' => wfMessage( 'userprofilev2-url-placeholder' )->plain(),
			'help-message' => 'userprofilev2-url-help',
		];
